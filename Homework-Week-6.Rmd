...
##Original data:
e<-predict(m,newdata = data.frame(Brain_Size_Species_Mean=800),interval="prediction",level=0.9)
e #The code isn't returning a point estimate and I'm not sure why...
str(df$Brain_Size_Species_Mean)
